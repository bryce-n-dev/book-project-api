...
class UserBook(Base):
    ...
    user_book_id = Column(String, primary_key=True) # Added primary key https://docs.sqlalchemy.org/en/14/faq/ormconfiguration.html#faq-mapper-primary-key
    isbn = Column(String, ForeignKey("book_info.isbn"), nullable=False)
